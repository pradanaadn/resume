...
\begin{document}
    ...
    \begin{header}
        ...
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{mailto:work.pradana@gmail.com}{work.pradana@gmail.com}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{tel:+62-812-3737-4363}{0812-3737-4363}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://pradanaadn.github.io/about/}{pradanaadn.github.io/about}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://linkedin.com/in/pradanaadn}{linkedin.com/in/pradanaadn}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://github.com/pradanaadn}{github.com/pradanaadn}}%
    \end{header}
