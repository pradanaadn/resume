...
\newcommand{\placelastupdatedtext}{% \placetextbox{<horizontal pos>}{<vertical pos>}{<stuff>}
  \AddToShipoutPictureFG*{% Add <stuff> to current page foreground
    \put(
        ...
        \small\color{gray}\textit{Last updated in December 2024 (Artificial Intelligence Intern ZettaByte)}\hspace{\widthof{Last updated in December 2024 (Artificial Intelligence Intern ZettaByte)}}
    }}}%
  }%
}%
...
\begin{document}
    ...
    \section{Technical Skills}
        ...
        \begin{onecolentry}
            \textbf{Language:} Python (Advanced), SQL (Intermediate), Bash (Intermediate)
        \end{onecolentry}
        ...
        \begin{onecolentry}
            \textbf{Machine Learning Modeling:} Pytorch, Tensorflow, Sklearn, Huggingface Transformer, OpenCV
        \end{onecolentry}
        ...
        \begin{onecolentry}
            \textbf{Cloud Service:} Azure AI Service, Google Cloud Platform, Google Colab
        \end{onecolentry}
