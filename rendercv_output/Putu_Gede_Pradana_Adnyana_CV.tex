...
\newcommand{\placelastupdatedtext}{% \placetextbox{<horizontal pos>}{<vertical pos>}{<stuff>}
  \AddToShipoutPictureFG*{% Add <stuff> to current page foreground
    \put(
        ...
        \small\color{gray}\textit{Last updated in December 2024 (Refonte Technologies)}\hspace{\widthof{Last updated in December 2024 (Refonte Technologies)}}
    }}}%
  }%
}%
...
\begin{document}
    ...
    \section{Technical Skills}
        ...
        \begin{onecolentry}
            \textbf{API and Web Development Framework:} Flask, FastAPI, Django REST API
        \end{onecolentry}
    ...
    \section{Experience}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item Implemented CI/CD pipelines to automate deployment processes, reducing deployment errors and downtime by 25\%, showcasing expertise in system optimization and reliability.
            \end{highlights}
        \end{onecolentry}
