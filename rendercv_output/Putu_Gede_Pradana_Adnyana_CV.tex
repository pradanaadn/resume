...
\newcommand{\placelastupdatedtext}{% \placetextbox{<horizontal pos>}{<vertical pos>}{<stuff>}
  \AddToShipoutPictureFG*{% Add <stuff> to current page foreground
    \put(
        ...
        \small\color{gray}\textit{Last updated in March 2025 (Junior Software Engineer)}\hspace{\widthof{Last updated in March 2025 (Junior Software Engineer)}}
    }}}%
  }%
}%
...
\begin{document}
    ...
    \begin{header}
        ...
        \normalsize
        \mbox{{\footnotesize\faMapMarker*}\hspace*{0.13cm}Tangerang, Indonesia}%
        \kern 0.0 pt%
        \AND%
        \kern 0.0 pt%
    ...
    \section{Education}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item \textbf{Coursework:} Discrete Mathematics, Calculus, Data Structure, Computer Architecture, Software Engineering, Machine Learning, Digital Image Processing, Big Data, OOP, Database, Computer Network, Information Technology Project Management, Computer Security
            \end{highlights}
        \end{onecolentry}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item Distinction Graduate, top 10\% of over 5,000 participants.
    ...
    \section{Technical Skills}
        ...
        \begin{onecolentry}
            \textbf{Programming Languages:} \textbf{Advanced}: Python; \textbf{Intermediate}: PHP, Javascript, SQL, Bash; \textbf{Beginner}: Java
        \end{onecolentry}
        ...
        \begin{onecolentry}
            \textbf{Machine Learning Modeling:} Pytorch, Tensorflow, Scikit-learn, Huggingface Transformer
        \end{onecolentry}
    ...
    \section{Projects}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item Tools Used: Python, SQL with ORM using SQLAlchemy, Streamlit, Microsoft Azure AI, and Power BI 
            \end{highlights}
        \end{onecolentry}
